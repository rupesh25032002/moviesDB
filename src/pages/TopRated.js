...
const TopRated = (props) => {
    ...
    const topRatedMoviesData = useSelector((state) => state?.moviesData?.topRatedMovie)
    return (
        <Wrapper>
            {
                isLoad
                    ?
                    <>
                        <div className='movie-heading'><h2>TOP RATED MOVIES</h2></div>
                        <div className='cards'>
                            {
                                topRatedMoviesData?.results.map((val) => {
                        ...
                        <div className='pagination'>
                            ...
                            {currentPage < topRatedMoviesData?.total_pages
                                ?
...
export default withEnhancement(TopRated, 1, "top_rated", getTopRatedMovie)
