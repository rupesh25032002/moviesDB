...
import { getPopularMovie } from '../slice/getmovies';
...
const Home = (props) => {
    ...
    const popularMoviesData = useSelector((state) => state?.moviesData?.popularMovies)
    return (
        <Wrapper>
            {
                isLoad
                    ?
                    <>
                        <div className='movie-heading'><h2>POPULAR MOVIES</h2></div>
                        <div className='cards'>
                            {
                                popularMoviesData?.results.map((val) => {
                        ...
                        <div className='pagination'>
                            ...
                            {currentPage < popularMoviesData?.total_pages
                                ?
...
export default withEnhancement(Home, 1, "popular", getPopularMovie)
